-- Update menu items with more appropriate images matching drink names

-- COFFEE DRINKS
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1561882468-9110e03e0f78?w=500' WHERE name = 'Cafe Latte';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=500' WHERE name = 'Spanish';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=500' WHERE name = 'Blueberry Latte';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1624353365286-3f8d62daad51?w=500' WHERE name = 'Oreo Cream';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1624353365286-3f8d62daad51?w=500' WHERE name = 'Matcha Oreo';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=500' WHERE name = 'Blueberry Matcha';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1624353365286-3f8d62daad51?w=500' WHERE name = 'Strawberry Oreo';

-- FRUIT SODAS
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1546173159-315724a31696?w=500' WHERE name = 'Lychee';
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1587049352846-4a222e784422?w=500' WHERE name = 'Blueberry';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=500' WHERE name = 'Strawberry';
...
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1587049352846-4a222e784422?w=500' WHERE name = 'Purple Soda';
UPDATE public.menu_items SET image_url = 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=500' WHERE name = 'Purple Strawberry';

-- Verify
SELECT name, image_url FROM public.menu_items ORDER BY name;
