-- Update KlaséCo Menu with new prices and items based on the official menu

-- First, let's update/create categories to match the menu structure
...
-- Insert COFFEE items (Daily price: 70, Extra: 90, Hot: 60)
...
-- Note: Daily size is 16oz, Extra size is 22oz
-- The base_price reflects the Daily (16oz) price
-- Hot option is available for coffee items at ₱60
